...
window.Investors = {
    ...
    async render(container) {
        ...
        const isOwner = (u.role === 'admin' || u.role === 'creator' || u.role === 'owner') && (!u.created_by || String(u.id) === String(ownerId));
        ...
        if (!isOwner) {
            container.innerHTML = `
                <div class="max-w-2xl mx-auto py-12 text-center font-jakarta">
                    ...
                    <p class="text-xs text-slate-400 font-inter mb-6 leading-relaxed">Shareholder capital, equity percentages, and dividend distributions are confidential and managed exclusively by the store administrator.</p>
